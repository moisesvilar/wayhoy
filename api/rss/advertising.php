...
$imageUrl = "http://promotv.mundo-r.com/promotv/api/".$config['images_directory']."/".$language."/".$config['advertising_image'];
...
<rss xmlns:atom="http://www.w3.org/2005/Atom" version="2.0">
    <channel>
        <title>WayHoy Contratación</title>
        <description>Explicación de cómo contratar el servicio WayHoy!.</description>
